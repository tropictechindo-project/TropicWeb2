...
export default async function ProductsPage() {
    ...
    const mappedProducts = products.map((p) => ({
        ...
        imageUrl: p.imageUrl || (p.images && p.images.length > 0 ? p.images[0] : '/placeholder-image.webp'),
    ...
    const mappedPackages = packages.map((pkg) => ({
        ...
        imageUrl: pkg.imageUrl || (pkg.images && pkg.images.length > 0 ? pkg.images[0] : '/placeholder-image.webp'),
    ...
    const mappedOffers = specialOffers.map((offer) => ({
        ...
        imageUrl: offer.images && offer.images.length > 0 ? offer.images[0] : '/placeholder-image.webp',
