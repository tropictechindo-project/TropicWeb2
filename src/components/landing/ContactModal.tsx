            ...
            <DialogContent className="sm:max-w-md bg-white border-0 shadow-2xl rounded-2xl overflow-hidden p-0">
                ...
                <div className="p-6">
                    <button
                        ...
                        className="w-full h-14 mb-8 flex items-center justify-center gap-3 bg-green-500 hover:bg-grey text-white rounded-xl shadow-lg hover:shadow-green-500/25 transition-all outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                    >
